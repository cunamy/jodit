...
var bundle = __webpack_require__(79);
...
class element_ToolbarElement extends Component_Component {
    ...
    createIcon(clearName, control) {
        ...
        const useText = control ? control.useText || false : false;
        const isTextBox = control ? control.isTextBox || false : false;
        const cssName = control ? control.cssName || '' : '';
        const idControl = control ? 'id=' + control.idComponent || false : '';
        ...
        if (!this.jodit.options.textIcons && !useText && !isTextBox) {
            ...
            const textValue = control ? control.textValue || '' : '';
            return this.jodit.create.fromHTML(`<input type='text' ${idControl}  class="jodit_icon ${cssName}" value="${textValue}"  />`);
        }
        else if (useText) {
            const textValue = control ? control.textValue || '' : '';
            return this.jodit.create.fromHTML(`<span ${idControl}  class="jodit_icon ${cssName}">${textValue}</span>`);
        }
...
// CONCATENATED MODULE: ./src/langs/ja.ts
...
// CONCATENATED MODULE: ./src/langs/pl.ts
/* harmony default export */ var pl = ({
    ...
    'GNU General Public License, version 2 or later': 'GNU General Public License, wersja 2 lub późniejsza',
